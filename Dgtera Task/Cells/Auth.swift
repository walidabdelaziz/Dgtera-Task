...
struct AuthResponseModel: Codable {
    var jsonrpc: String?
    var id: Int?
    var result: AuthSuccessModel?
    var error: AuthErrorModel?
}
struct AuthErrorModel: Codable {
    var message: String?
}

struct AuthSuccessModel: Codable {
    var uid: Int?
    var isSystem, isAdmin: Bool?
    var userContext: UserContext?
    var db, serverVersion: String?
    var serverVersionInfo: [ServerVersionInfo]?
    var name, username, partnerDisplayName: String?
    var companyID, partnerID: Int?
    var webBaseURL: String?
    var activeIDSLimit, maxFileUploadSize: Int?
    var userCompanies: UserCompanies?
    var currencies: [String: Currency]?
    var showEffect: String?
    var displaySwitchCompanyMenu: Bool?
    var cacheHashes: CacheHashes?
    var userID: [Int]?
    var maxTimeBetweenKeysInMS: Int?
    var webTours: [JSONAny]?
    var notificationType: String?
    var odoobotInitialized, shEnableOneClick: Bool?
    var userBrands: UserBrands?
    var displaySwitchBrandMenu: Bool?
    var allowedBrandIDS: [JSONAny]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case allowedBrandIDS = "allowed_brand_ids"
    }
}

// MARK: - CacheHashes
struct CacheHashes: Codable {
    var loadMenus, qweb, translations: String?
...
struct UserBrands: Codable {
    var currentBrand: [Bool]?
    var allowedBrand: [JSONAny]?

    enum CodingKeys: String, CodingKey {
        case currentBrand = "current_brand"
        case allowedBrand = "allowed_brand"
    }
}

// MARK: - UserCompanies
struct UserCompanies: Codable {
    var currentCompany: [ServerVersionInfo]?
    var allowedCompanies: [[ServerVersionInfo]]?
